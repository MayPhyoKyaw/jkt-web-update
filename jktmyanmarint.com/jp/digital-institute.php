...
<body>
        ...
        <ul class="navbar-nav ms-auto text-sm-start">
          ...
          <li class="lang">
            <div class="btn-group" role="group" aria-label="First group">
              ...
              <a href=../mm/digital-institute.php><button type="button" class="btn btn2">
                  <img src="../assets/images/icon/mmFlag.svg" height="20px" width="25px" />
                </button></a>
              <a href=./digital-institute.php><button type="button" class="btn btn3" style="background-color: rgba(91, 175, 231, 0.5)">
  ...
  <nav aria-label="breadcrumb" class="breadcrumb-nav d-none d-md-block">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">デジタル学院</li>
    </ol>
  </nav>
        ...
        <div class="col-lg-10 detail-info-blog">
          ...
          <div class="blog-details">
            ...
            <div class="quote-wrapper">
              <div class="quotes">
                日本で働きたい方、地元のIT企業や日本のIT企業で働きたい方へ向けて、
                最適な学習環境を提供しています。
                授業は基礎から上級レベルまで利用できます。
                JKTミャンマーインターナショナルには優秀な先生たちがいますので、
                理論や戦略を教えるだけではなく、学生たちも実際の現場の
                ミニプロジェクト作成の作業環境を体験・提供できます。1F973
              </div>
            </div>
          </div>
        </div>
