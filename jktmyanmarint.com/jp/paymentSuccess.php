        ...
        <ul class="navbar-nav ms-auto text-sm-start">
          ...
          <li class="lang">
            <div class="btn-group" role="group" aria-label="First group">
              ...
              <a href="../mm/paymentSuccess.php"><button type="button" class="btn btn2">
                  <img src="../assets/images/icon/mmFlag.svg" height="20px" width="25px" /></button></a>
              <a href="./paymentSuccess.php"><button type="button" class="btn btn3" style="background-color: rgba(91, 175, 231, 0.5)">
                ...
                <div class="row justify-content-center">
                  <div class="col-7 text-center">
                    <h5 class="blue-text-payment text-center">
                      できるだけ早くご連絡いたします。<br>
                      お支払いをすぐに確認したい場合は、<br>
                      営業時間内（９：００　～　１７：００）に下記の電話番号までご連絡ください。<br>
