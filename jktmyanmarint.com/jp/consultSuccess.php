        ...
        <ul class="navbar-nav ms-auto text-sm-start">
          ...
          <li class="lang">
            <div class="btn-group" role="group" aria-label="First group">
              <a href="../consultSuccess.php"><button type="button" class="btn btn1">
              ...
              <a href=./consultSuccess.php><button type="button" class="btn btn3" style="background-color: rgba(91, 175, 231, 0.5)">
