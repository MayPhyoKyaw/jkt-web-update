        ...
        <ul class="navbar-nav ms-auto text-sm-start">
          ...
          <li class="lang">
            <div class="btn-group" role="group" aria-label="First group">
              <a href="../enrollSuccess.php"><button type="button" class="btn btn1">
                  <img src="../assets/images/icon/ukFlag.png" height="20px" width="25px" /></button></a>
              <a href="./enrollSuccess.php"><button type="button" class="btn btn2" style="background-color: rgba(91, 175, 231, 0.5)">
