...
<body>
        ...
        <ul class="navbar-nav ms-auto text-sm-start">
          ...
          <li class="lang">
            <div class="btn-group" role="group" aria-label="First group">
              <a href="./digital-institute.php"><button type="button" class="btn btn1" style="background-color: rgba(91, 175, 231, 0.5)">
  ...
  <nav aria-label="breadcrumb" class="breadcrumb-nav d-none d-md-block">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">DIGITAL INSTITUTE</li>
    </ol>
  </nav>
            ...
            <table class="schedule-table">
              ...
              <tbody>
                ...
                $schedule = "SELECT course_id, c.title AS course_title, cty.title AS category_title,
                                  t.title AS type_title, level_or_sub, fee, instructor, services, 
                                  discount_percent, start_date, duration, sections, note
