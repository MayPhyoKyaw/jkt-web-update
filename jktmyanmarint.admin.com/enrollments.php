...
$result = mysqli_query($conn, "SELECT enrollment_id, e.course_id AS course_id, title, level_or_sub, photo, student_name, nrc, payment_method, paid_amount, discount_amount, is_pending, e.created_at AS created_at,
                                    ...
                                    <table class="table table-bordered my-table" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="select-paidAmount-filter">Paid Amount</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr onclick="setCurrentDetail(this)" data-toggle="modal" data-target="#detailModal" class="tb-row">
                                                    ...
                                                    <td><?= $row['paid_amount'] . " MMKs" ?></td>
                                                    <td class="pending-badges"><?php echo $row['is_pending'] == 0 ? "&#9989;" : "&#10060;" ?></td>
                                                    <td><?= date('Y-m-d', strtotime($row['created_at'])) ?></td>
                                                    <td><?= date('Y-m-d', strtotime($row['updated_at'])) ?></td>
                                                    <td><button class="tb-btn tb-btn-edit" onclick="setCurrentEditing(event,this,<?php echo $row['enrollment_id'] ?>,<?php echo $row['course_id'] ?>,<?php echo $row['fee'] ?>,<?php echo $row['discount_amount'] ?>)" data-toggle="modal" data-target="#editingModal"><i class="fa fa-pencil"></i></button></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="col-12" id="editingModal" action="backend/editEnrollment.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class=" form-group mb-4 row align-items-center px-3">
                            ...
                            <div class="text-center offset-2 col-6">
                                ...
                                <div class="form-group mb-2 payment-badge">
                                    ...
                                    <label id="showDiscount"></label>
                                </div>
                                <div class="form-group payment-badge">
                                    <label for="totalCourseFee">Total Course Fee - </label>
                                    <label id="totalCourseFee" style="text-decoration: line-through;"></label>
                                    <label id="realFee"></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="paidAmount" id="paidAmount" class="form-control" />

                        <div class="form-group mb-4" id="newPaymentField">
                            <label for="newPaymentField">New Payment Amount (MMKs)</label>
