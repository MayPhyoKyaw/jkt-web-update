                                            ...
                                            <table class="table table-bordered" id="enDT" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php while ($row = mysqli_fetch_assoc($en_result)) : ?>
                                                        <tr onclick="jobDetail(event,'<?php echo $row['job_id'] ?>','eng')" data-toggle="modal" data-target="#detailModal" class="tb-row">
                                            ...
                                            <table class="table table-bordered" id="mmDT" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php while ($row = mysqli_fetch_assoc($mm_result)) : ?>
                                                        <tr onclick="jobDetail(event,'<?php echo $row['job_id'] ?>','mm')" data-toggle="modal" data-target="#detailModal" class="tb-row">
                                                            <td><img class="check-icon" src="img/1.png" onclick="addToSelected(event,'<?= $row['job_id'] ?>')" /></td>
                                                            <td><?= $row['job_id'] ?></td>
                                                            <td><?= $row['job_title'] ?></td>
                                                            <td><?= $row['company_name'] ?></td>
                                            ...
                                            <table class="table table-bordered" id="jpDT" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php while ($row = mysqli_fetch_assoc($jp_result)) : ?>
                                                        <tr onclick="jobDetail(event,'<?php echo $row['job_id'] ?>','jp')" data-toggle="modal" data-target="#detailModal" class="tb-row">
                                                            <td><img class="check-icon" src="img/1.png" onclick="addToSelected(event,'<?= $row['job_id'] ?>')" /></td>
                                                            <td><?= $row['job_id'] ?></td>
                                                            <td><?= $row['job_title'] ?></td>
                                                            <td><?= $row['company_name'] ?></td>
